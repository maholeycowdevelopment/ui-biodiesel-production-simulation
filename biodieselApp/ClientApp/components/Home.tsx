...
export class Home extends React.Component<RouteComponentProps<{}>, {}> {
    public render() {
        return <div>
            <h1>University of Idaho Biodiesel Education Program</h1>
            <p>Welcome to the online biodiesel studio presented by the University 
            ...
            studio. Check out the links below if you want to learn more about the
